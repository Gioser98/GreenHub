...
public class RewardFactory {
	...
	static {
		rewardTypes.put("Sconto del 100% sulla prossima ricarica", new RFFreeRechargeReward());
		rewardTypes.put("Sconto del 20% sulla prossima ricarica", new RFDiscount20PercentReward());
		...
		prefixToRewardType.put("20", "Sconto del 20% sulla prossima ricarica");  // Prefisso "20" corrisponde a Discount20
		prefixToRewardType.put("100", "Sconto del 100% sulla prossima ricarica"); // Prefisso "100" corrisponde a FreeRecharge
	}
