...
public class MMRechargeVehicleStrategy implements MainMenuStrategy {
	...
	public void execute(UserInterface ui, User user) throws IOException {
		...
		ui.getView().showMessage("Stai per ricaricare il veicolo: " + (currentVehicle.getMaker() != null ? currentVehicle.getMaker() : "Produttore sconosciuto") + " " + (currentVehicle.getModel() != null ? currentVehicle.getModel() : "Modello sconosciuto") + ". Vuoi continuare? (s/n)");
